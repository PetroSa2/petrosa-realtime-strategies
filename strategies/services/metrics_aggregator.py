...
class MetricsAggregator:
    ...
    async def get_metric_trends(
        ...
        try:
            ...
            num_points = min(period_seconds // interval_seconds, 100)  # Limit to 100 points
    ...
    async def compare_metrics(
        ...
        try:
            ...
            improvements = sum(1 for m in comparison.values() if m.get("improvement", False))
            degradations = sum(1 for m in comparison.values() if not m.get("improvement", True))
            ...
            if improvements > degradations:
                ...
                overall = "degraded"
                recommendation = "Configuration change had negative impact - consider reverting"
            else:
                overall = "mixed"
                recommendation = "Configuration change had mixed results - further analysis needed"
            ...
            return {"comparison": {}, "overall_assessment": "unknown", "recommendation": ""}

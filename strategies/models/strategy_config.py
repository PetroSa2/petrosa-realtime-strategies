...
class StrategyConfig(BaseModel):
    ...
    symbol: Optional[str] = Field(
        None,
        description="Trading symbol (None for global configs)"
    )
    ...
    created_by: str = Field(
        ...,
        description="Who/what created this config"
    )
...
class StrategyConfigAudit(BaseModel):
    ...
    config_id: Optional[str] = Field(None, description="Configuration ID that was changed")
    strategy_id: str = Field(..., description="Strategy identifier")
...
class StrategyInfo(BaseModel):
    ...
    has_global_config: bool = Field(
        False,
        description="Whether global config exists"
    )
    symbol_overrides: List[str] = Field(
        default_factory=list,
        description="Symbols with overrides"
    )
...
class ConfigSource(BaseModel):
    ...
    load_time_ms: Optional[float] = Field(
        None,
        description="Time taken to load config"
    )

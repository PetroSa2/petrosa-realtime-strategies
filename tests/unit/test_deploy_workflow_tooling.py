...
silently stopping fixed images from ever reaching the cluster (see
petrosa-realtime-strategies#238, mirroring the same regression already
root-caused and fixed for petrosa-data-manager#338/#339 and petrosa-cio#233).

...
from strategies.models.market_data import MarketData, OrderBookData, TradeData
from strategies.models.signals import MarketSignal, SignalType, SignalStrength
...
class TestCrossExchangeSpreadAnalyzer:
    ...
    def test_identify_arbitrage_opportunities(self):
        ...
        assert all('buy_exchange' in opp and 'sell_exchange' in opp for opp in opportunities)
    ...
    def test_spread_historical_analysis(self):
        ...
        historical_spreads = [
            {'timestamp': datetime.utcnow() - timedelta(minutes=i), 'spread': 0.001 + i * 0.0001}
            for i in range(60)
        ]
    ...
    def test_minimum_profit_threshold(self):
        ...
        small_spread_books = {
            'binance': self.create_sample_orderbook("BTCUSDT", "binance", 50000),
            'coinbase': self.create_sample_orderbook("BTCUSDT", "coinbase", 50050)  # 0.1% spread
        }
...
class TestOnChainMetricsAnalyzer:
    ...
    def test_whale_movement_detection(self):
        ...
        large_transactions = [
            ...
            {'amount': 500, 'from_exchange': True, 'to_exchange': False},    # Exchange to whale
            {'amount': 2000, 'from_exchange': False, 'to_exchange': False}   # Whale to whale
        ]
    ...
    def test_correlation_with_price_movements(self):
        ...
        correlation = analyzer.calculate_price_correlation(onchain_history, price_history)
